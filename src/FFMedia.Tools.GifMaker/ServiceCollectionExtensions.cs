...
public static class ServiceCollectionExtensions
{
    ...
    /// from it — and note that it also needs an <c>ISettingsService</c>, an <c>IHistoryService</c> and
    /// an <c>INotificationService</c>, all of which are registered elsewhere in the composition root
    /// (the notification service is realized in the App layer, the snackbar, not in Core).</remarks>
